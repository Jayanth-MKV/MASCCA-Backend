...
import { InstructorDocument } from 'src/models/instructor.schema';
export declare class UserService {
    private userModel;
    private hashService;
    private instructorModel;
    logger: Logger;
    constructor(userModel: Model<UserDocument>, hashService: HashService, instructorModel: Model<InstructorDocument>);
    ...
    getPassByEmail(email: string): Promise<import("mongoose").Document<unknown, {}, UserDocument> & User & import("mongoose").Document<any, any, any> & {
        _id: import("mongoose").Types.ObjectId;
    }>;
    findByRoll(roll: string): Promise<import("mongoose").Document<unknown, {}, UserDocument> & User & import("mongoose").Document<any, any, any> & {
        _id: import("mongoose").Types.ObjectId;
    }>;
    getPassByRoll(roll: string): Promise<import("mongoose").Document<unknown, {}, UserDocument> & User & import("mongoose").Document<any, any, any> & {
        _id: import("mongoose").Types.ObjectId;
    }>;
    ...
    remove(id: string): Promise<import("mongoose").Document<unknown, {}, UserDocument> & User & import("mongoose").Document<any, any, any> & {
        _id: import("mongoose").Types.ObjectId;
    }>;
}
